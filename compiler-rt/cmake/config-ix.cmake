...
if(APPLE)
  ...
  list_intersect(SAFESTACK_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(FPS_SUPPORTED_ARCH
    ALL_FPS_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(LOCKBOX_SUPPORTED_ARCH
    ALL_LOCKBOX_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(SAFESTACK_SUPPORTED_ARCH
    ${ALL_SAFESTACK_SUPPORTED_ARCH})
  filter_available_targets(FPS_SUPPORTED_ARCH ${ALL_FPS_SUPPORTED_ARCH})
  filter_available_targets(LOCKBOX_SUPPORTED_ARCH ${ALL_LOCKBOX_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;rtsan;dfsan;msan;hwasan;tsan;tysan;safestack;fps;lockbox;cfi;scudo_standalone;ubsan_minimal;gwp_asan;nsan;asan_abi)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND FPS_SUPPORTED_ARCH AND OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_FPS TRUE)
else()
  message(FATAL_ERROR "FPS_SUPPORTED_ARCH=${FPS_SUPPORTED_ARCH} ALL_FPS_SUPPORTED_ARCH=${ALL_FPS_SUPPORTED_ARCH} SANITIZER_COMMON_SUPPORTED_ARCH=${SANITIZER_COMMON_SUPPORTED_ARCH}")
  set(COMPILER_RT_HAS_FPS FALSE)
endif()

if (COMPILER_RT_HAS_SANITIZER_COMMON AND LOCKBOX_SUPPORTED_ARCH AND OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_LOCKBOX TRUE)
else()
  set(COMPILER_RT_HAS_LOCKBOX FALSE)
endif()
